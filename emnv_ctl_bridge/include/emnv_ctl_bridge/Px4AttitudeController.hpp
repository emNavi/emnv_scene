 ...
 */
inline Eigen::Quaterniond getAttiErr(const Eigen::Vector3d src, const Eigen::Vector3d dst, const double eps = double(1e-5))
{
...
// canonical form
inline Eigen::Quaterniond eigen_canonical(Eigen::Quaterniond q)
{
